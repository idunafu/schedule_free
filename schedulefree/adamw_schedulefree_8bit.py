...
class AdamWScheduleFree8bit(torch.optim.Optimizer):
    r"""
    Schedule-Free AdamW with an 8-bit second moment state.

    This optimizer stores the Adam second moment estimate (`exp_avg_sq`) in a
    ...
    directly and is usually much riskier than quantizing optimizer statistics.
